...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?php echo base_url(); ?>" class="bg-primary"><b>Penentuan Produk </b>Unggulan</a>
    </div>
    <!-- /.login-logo -->
    ...
    <div class="login-box-body ">
      <p class="login-box-msg text-primary">Penentuan Produk Unggulan Daerah menggunakan metode Composite Performace Index</p>
        ...
        <div class="row">
          <div class="col-xs-8">
            <div class="checkbox icheck">
              <label>
                <a href="<?php echo base_url('landing'); ?>">Kembali</a>
              </label>
            </div>
          </div>
          <!-- /.col -->
